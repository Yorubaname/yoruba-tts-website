...
$(function() {
    ...
    $(".share a.btn-social").on("click", function(ev) {
      ...
      if (/(facebook|twitter)/.test(ev.currentTarget.href)) {
        var c = 575,
          ...
          f = ($(window).height() - d) / 2,
          g =
            "status=1,width=" + c + ",height=" + d + ",top=" + f + ",left=" + e;
  ...
  $('form[name="name_feedback"]').on("submit", function(e) {
    ...
    return $.ajax({
      ...
      success: function(resp) {
        ...
        $(".response")
          .html(alert_success("Feedback posted successfully. Thanks."))
          .fadeIn();
        setTimeout(function() {
      ...
      error: function(jqXHR) {
        $(".response")
          .html(alert_error(jqXHR.responseJSON.message || jqXHR.responseText))
          .fadeIn();
      }
    });
  });
  ...
  $(function() {
    ...
    $("#opener").click(function() {
      ...
      var longUrl = "https://ttsy.page.link/?link=" + rootUrl + "/?q=" + text;
      var urlShortener =
        "https://firebasedynamiclinks.googleapis.com/v1/shortLinks?key=AIzaSyA8K3Hi_EHUufpmmRCouMTU0w_3NLwZ5wI";
      ...
      $.ajax({
        ...
        .done(function(data, textStatus, jqXHR) {
          var shortUrl = data.shortLink; // John
          ...
          $("#share-twitter").attr(
            ...
            "https://twitter.com/intent/tweet?url=" +
              ...
              "&text=" +
              twitterText +
              "&hashtags=TTSYoruba&via=TTSYoruba"
          );
  ...
  $(function() {
    ...
    $("form#suggest-form").on("submit", function(event) {
      ...
      $.ajax({
        ...
        .success(function() {
          $(".response")
            .html(alert_success("Name was submitted successfully. Thank you."))
            .fadeIn();
        })
        .fail(function(jqXHR) {
          $(".response")
